...
True Drawing e' in fase iniziale. In questa versione e' disponibile lo skeleton desktop con canvas interattivo, strumenti di tratto, layer e undo/redo: l'app Electron mostra la finestra principale, carica la configurazione centrale e permette di disegnare sul canvas con input compatibili con Pointer Events.
