...
Il progetto e' in fase iniziale. La versione corrente e' `0.3.0` e contiene lo skeleton desktop Electron/Vite/React, struttura modulare, configurazione centrale validata, canvas interattivo con Pointer Events, strumenti matita/pennarello/pennello/gomma, controlli tratto, undo/redo, CI con lint/test/build e workflow release Windows/macOS.
...
- Undo e redo per i tratti disegnati.
...
The project is at its initial stage. Current version is `0.3.0` and includes the Electron/Vite/React desktop skeleton, modular structure, validated central configuration, interactive canvas with Pointer Events, pencil/marker/brush/eraser tools, stroke controls, undo/redo, CI with lint/test/build, and Windows/macOS release workflow.
...
- Undo and redo for drawn strokes.
