...
Il progetto e' in fase iniziale. La versione corrente e' `0.2.0` e contiene lo skeleton desktop Electron/Vite/React, struttura modulare, configurazione centrale validata, canvas interattivo con Pointer Events, CI con lint/test/build e workflow release Windows/macOS.
...
The project is at its initial stage. Current version is `0.2.0` and includes the Electron/Vite/React desktop skeleton, modular structure, validated central configuration, interactive canvas with Pointer Events, CI with lint/test/build, and Windows/macOS release workflow.
